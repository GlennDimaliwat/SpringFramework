...
import com.glenndimaliwat.app.domain.Role;
...
public class UserDetailsImpl implements UserDetails {
	 ...
	 * 
	 */
	private static final long serialVersionUID = -2620916811968827904L;
	...
	public String toString() {
		return "UserDetailsImpl [getAuthorities()=" + getAuthorities() + ", getPassword()=" + getPassword()
